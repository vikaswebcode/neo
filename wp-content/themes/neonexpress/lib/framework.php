<?php
/**
 * Various functions required for braaf-bootstrap to work properly
 *
 ...
 * Class Name: ne_navwalker
 * GitHub URI: https://github.com/twittem/wp-braaf-navwalker
 * Description: A custom WordPress nav walker class to implement the braaf 3 navigation style in a custom theme using the WordPress built in menu manager.
 */
class Braaf_Navwalker extends Walker_Nav_Menu {
	/**
	 * Walker::start_lvl()
	 *
...
/**
 * Pagination
 * Custom pagination with braaf .pagination class
 * source: http://www.ordinarycoder.com/paginate_links-class-ul-li-braaf/
 *
 * @param boolean $echo echo
 * @return string
 */
function ne_pagination( $echo = true ) {
	global $wp_query;
 ...
 * braaf Comments Tree
 */
if ( ! class_exists( 'Braaf_Comments' ) ) :
	/**
	 * Undocumented class
	 */
	class Braaf_Comments extends Walker_Comment {
		/**
		 * tree_type
		 *
