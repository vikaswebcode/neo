...
if ( ! class_exists( 'Braaf_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * Braaf_Protocol_Relative_Theme_Assets class
	 */
	class Braaf_Protocol_Relative_Theme_Assets {
		/**
	...
	$ne_protocol_relative_theme_assets = new Braaf_Protocol_Relative_Theme_Assets();
endif;
